...
public class Env
{
	...
	public static void setEnvVar(String sVarName, String sValue) throws Exception
	{
		System.setProperty(sVarName, sValue);
		injectEnvironmentVariable(sVarName, sValue);
	}
